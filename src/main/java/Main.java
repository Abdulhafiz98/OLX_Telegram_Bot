...
public class Main {
    ...
    public static void readUsersFile(){
        ...
        if(file.exists()){
            try (BufferedReader bufferedReader = new BufferedReader(new FileReader(file))) {
                DataBase.LIST_OF_USERS = gson.fromJson(bufferedReader,new TypeToken<List<Tg_User>>(){}.getType());
    ...
    public static void readProductsFile(){
        ...
        if(file.exists()){
            try (BufferedReader bufferedReader = new BufferedReader(new FileReader(file))) {
                DataBase.LIST_OF_PRODUCTS = gson.fromJson(bufferedReader,new TypeToken<List<Product>>(){}.getType());
    ...
    public static void readCategoriesFile(){
        ...
        if(file.exists()){
            try (BufferedReader bufferedReader = new BufferedReader(new FileReader(file))) {
                DataBase.LIST_OF_CATEGORY = gson.fromJson(bufferedReader,new TypeToken<List<Category>>(){}.getType());
